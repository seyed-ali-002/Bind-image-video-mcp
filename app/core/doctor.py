...
def doctor():
 ...
 return {"healthy":all(checks.values()),"checks":checks,"python":sys.version.split()[0],"platform":info(),"ffmpeg":bool(shutil.which("ffmpeg")),"tailscale":bool(shutil.which("tailscale")),"providers":provider_status()}
